...
<head>
    ...
    <title>Poliuretanos | Ferreterías Bolívar</title>
...
<div class="fondoa">
    ...
    <section class="property-grid grid">
      <!--Poliuretano Axalta-->
      <div class="container" id="axalta">
             <div class="section-title" >
                <h2>Poliuretano Axalta</h2>
             </div>
          <div class="row">
            <!--P1-->
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliuretanos/Axalta/1.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Chroma Primer 52320N</h4>
                        </div> 
                    </div>
                  </div>
                </div>
        ...
        <!--Poliuretanos Glasurit-->
        <div class="container" id="glasurit">
             <div class="section-title" >
                <h2>Poliuretanos Glasurit</h2>
             </div>
          <div class="row">
            <!--P1-->
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliuretanos/Glasurit/1.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Poliuretano Línea 22</h4>
                        </div> 
                    </div>
                  </div>
                </div>
        ...
        <!--Poliuretanos Sherwin Williams-->
        <div class="container" id="sherwin-williams">
             <div class="section-title" >
                <h2>Poliuretanos Sherwin Williams</h2>
             </div>
          <div class="row">
            <!--P1-->
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliuretanos/SherwinWilliams/1.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Lazzudur Alto Sólidos</h4>
                        </div> 
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliuretanos/SherwinWilliams/2.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Poliuretano Fleetcolor</h4>
                        </div> 
                    </div>
                  </div>
                </div>
         ...
         <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliuretanos/SherwinWilliams/3.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Poliuretanos Condorthane</h4>
                        </div> 
                    </div>
                  </div>
                </div>
