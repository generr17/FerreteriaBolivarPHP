...
<head>
    ...
    <title>Poliester | Ferreterías Bolívar</title>
    ...
    <section class="property-grid grid">
      ...
      <div class="container" id="axalta">
          ...
          <div class="row">
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliester/Axalta/1.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Chroma Primer Base 62320</h4>
                        </div> 
                    </div>
                  </div>
                </div>
         ...
         <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliester/Axalta/2.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Poliester Power Tint</h4>
                        </div> 
                    </div>
                  </div>
                </div>
        ...
        <div class="container" id="glasurit">
          ...
          <div class="row">
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliester/Glasurit/1.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Poliester Línea 55</h4>
                        </div> 
                    </div>
                  </div>
                </div>
        ...
        <!--Poliester Sherwin Williams-->
        <div class="container" id="sherwin-williams">
             <div class="section-title" >
                <h2>Poliester Sherwin Williams</h2>
             </div>
          <div class="row">
            <!--P1-->
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliester/SherwinWilliams/1.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Poliester Lazzudur Base</h4>
                        </div> 
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/PinturasAutomotrices/Poliester/SherwinWilliams/2.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Ultra 7000 Ultrabase</h4>
                        </div> 
                    </div>
                  </div>
                </div>
