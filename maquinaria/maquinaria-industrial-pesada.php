...
<head>
    ...
    <title>Maquinaria industrial pesada | Ferreterías Bolívar</title>
...
<div class="fondoa">
    ...
    <section class="property-grid grid">
        <!--Alisadores-->
        <div class="container" id="alisadores">
          ...
          <div class="row">
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Alisadores/ingco.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Alisador Ingco</h4>
                        </div> 
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Alisadores/masalta.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Alisador Masalta</h4>
                        </div> 
                    </div>
                  </div>
                </div>
         ...
         <!--Compactadoras-->
        <div class="container" id="compactadoras">
             <div class="section-title" >
                <h2>Compactadoras</h2>
             </div>
          <div class="row">
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Compactadoras/ingco.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Compactadora Ingco</h4>
                        </div> 
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Compactadoras/masalta.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Compactadora Masalta</h4>
                        </div> 
                    </div>
                  </div>
                </div>
        ...
        <!--Concreteras-->
        <div class="container" id="concreteras">
             <div class="section-title" >
                <h2>Concreteras</h2>
             </div>
          <div class="row">
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Concretera/ingco.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Concretera Ingco</h4>
                        </div> 
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Concretera/masalta.jpg" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-footer-a" style="bottom:-420px">
                        <div class="descripcion">
                            <h4 class="card-info-title">Concretera Masalta</h4>
                        </div> 
                    </div>
                  </div>
                </div>
        ...
        <div class="container" id="mezcladoras-de-cemento">
             <div class="section-title" >
                <h2>Mezcladora de cemento</h2>
             </div>
          <div class="row">
            <!--P1-->
            <div class="col-md-4" >
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="https://ferreteriasbolivar.com/assets/img/productos/Maquinaria/Mezcladoradecemento/1.jpg" alt="" class="img-a img-fluid">
                </div>
              </div>
            </div>
